...
class TaskRepositoryImpl private constructor(
    ...
    override suspend fun deleteTasksById(taskId: List<Long>): Int {
        return localSource.deleteTasksById(taskId)
    }
    ...
    override suspend fun addExtensionToSession(
        ...
        return localSource.addExtensionToSession(sessionId, addedExtensionMs)
    }
    ...
    override suspend fun adjustActualDurationWithGap(
        ...
        localSource.adjustActualDurationWithGap(sessionId, additionalMs)
    }

    override fun getTaskTitleFlow(taskId: Long): Flow<String> {

        return localSource.getTaskTitleFlow(taskId)
    }


    override suspend fun updateTaskTitle(taskId: Long, newTitle: String) {

        return localSource.updateTaskTitle(taskId, newTitle)
